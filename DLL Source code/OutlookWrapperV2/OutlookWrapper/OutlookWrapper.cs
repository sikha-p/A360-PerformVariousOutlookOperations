...
namespace OutlookWrapper
{
    public class OutlookWrapper
    {
        ...
        public string SelectAccount()
        {
            try
            {
                application = getOutLookInstance();
            ...
            {
                return ERROR + ex.ToString()+ application;
            }
        }
        ...
        public string[] GetAllMailIDsArray(string NumberOfItems,bool Descending=false)
        {
            return PrepareGetMailIDsArrayResponse(NumberOfItems, string.Empty, Descending);
        }

        public string[] GetUnReadMailIDsArray(string NumberOfItems,bool Descending= false)
        {
            return PrepareGetMailIDsArrayResponse(NumberOfItems, "[Unread]=true", Descending);
        }

        public string[] GetReadMailIDsArray(string NumberOfItems,bool Descending= false)
        {
            return PrepareGetMailIDsArrayResponse(NumberOfItems, "[Unread]=false", Descending);
        }

        public string[] GetMailIDsArrayByFilter(string Filter,bool Descending= false)
        {
            return PrepareGetMailIDsArrayResponse(Int32.MaxValue.ToString(), Filter, Descending);
        }

        public string[] GetMailIDsArrayByDateRange(string StartDate, string EndDate,bool Descending= false)
        {
        ...
        private string[] PrepareGetMailIDsArrayResponse(string NumberOfItems, string Filter,bool Descending)
        {
            List<string> IDs = new List<string>();
            ...
            try
            {
                ...
                application = getOutLookInstance();
                account = application.Session.Accounts[1];
                folder = account.Session.GetDefaultFolder(Outlook.OlDefaultFolders.olFolderInbox);
                Console.WriteLine("\nDescription : " + folder.Description + "\nStoreId : " + folder.StoreID);
                ...
                items.Sort("[ReceivedTime]", Descending);
        ...
        public string GetSentOnDate(string ID)
        ...
        public string GetIsUnReadStatus(string ID)
        {
            try
            {
                var result = SelectMailItem(ID);
        ...
        public string GetFlagStatus(string ID)
        {
            try
            {
                var result = SelectMailItem(ID);
